...
public class NationaleResponsableResource {
    ...
    @GetMapping("")
    public ResponseEntity<List<NationaleResponsableDTO>> getAllNationaleResponsables() {
        List<NationaleResponsableDTO> nationaleResponsableDTOS = nationaleResponsableService.getAllNationaleResponsables();
        return new ResponseEntity<>(nationaleResponsableDTOS, HttpStatus.OK);
    }
    ...
    public ResponseEntity<PageRequestData<NationaleResponsableDTO>> getNationaleResponsables(
        ...
        PageRequestData<NationaleResponsableDTO> nationaleResponsables =
                nationaleResponsableService.getAllNationaleResponsablesPaginated(pageRequest);
